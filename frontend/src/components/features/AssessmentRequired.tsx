...
interface AssessmentRequiredProps {
  onStartAssessment: () => void;
  onBackToHome: () => void;
}

export function AssessmentRequired({ onStartAssessment, onBackToHome }: AssessmentRequiredProps) {
  const { t } = useLanguage();
  ...
  const competencies = [
    { key: "analytical", name: "Analitik Düşünme", icon: Brain, color: "#1FB9FF" },
    { key: "empathy", name: "Empati", icon: Heart, color: "#FF8E4D" },
    { key: "decision", name: "Hızlı ve Soğukkanlı Karar Alma", icon: Zap, color: "#7C6BFF" },
    { key: "resilience", name: "Duygusal Dayanıklılık", icon: Shield, color: "#F6B44B" },
    { key: "numerical", name: "Sayısal Zeka", icon: Calculator, color: "#2AA9FF" },
    { key: "stress", name: "Stres Yönetimi", icon: Leaf, color: "#12C2FF" },
    { key: "teamwork", name: "Takım Çalışması", icon: Users, color: "#5C2BFF" },
    { key: "technology", name: "Teknoloji Adaptasyonu", icon: Smartphone, color: "#FFA063" }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-800 via-blue-900 to-purple-900 relative overflow-hidden">
      ...
      <div className="container py-20 relative z-10">
        ...
        >
          ...
          >
            Kapsamlı değerlendirme ile güçlü yönlerini keşfet, gelişim alanlarını belirle ve kariyer yolculuğuna başla!
          </motion.p>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <p className="text-white/90 text-sm">{competency.name}</p>
                  </div>
                </motion.div>
              );
            })}
        ...
        <section>
          ...
          >
            ...
            <p className="text-xl text-white/80 max-w-3xl mx-auto">
              Gerçek hayat senaryoları ile yetkinliklerini değerlendiriyoruz
            </p>
          </motion.div>
